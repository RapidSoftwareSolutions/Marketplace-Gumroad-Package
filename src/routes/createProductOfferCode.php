...
$app->post('/api/Gumroad/createProductOfferCode', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','id','name','amountOff']);
    ...
    $data['amount_off'] = $post_data['args']['amountOff'];
    ...
    $query_str = $settings['api_url'] . "products/$id/offer_codes";
