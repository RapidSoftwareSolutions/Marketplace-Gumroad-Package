...
$app->post('/api/Gumroad/createProductVariant', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','id','categoryId','name','priceDifferenceCents']);
